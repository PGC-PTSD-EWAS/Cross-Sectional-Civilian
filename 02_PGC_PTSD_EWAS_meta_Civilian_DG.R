...
load("PGC_EWAS_combinedData_civilian_DG.Rdata")
...
save.image("PGC_EWAS_DataPrep_nonSmoke_civilian_DG.Rdata")
...
save.image("PGC_EWAS_DataPrep_nonSmoke_intersectSites_civilian_DG.Rdata")
...
save.image("PGC_EWAS_DataPrep_nonSmoke_remainingSites_civilian_DG.Rdata")
...
load("PGC_EWAS_DataPrep_nonSmoke_intersectSites_civilian_DG.Rdata")
...
save(res, file="PGC_EWAS_nonSmoke_inverseNorm_intersectSites_civilian_DG_10.05.17.Rdata")
...
load("PGC_EWAS_DataPrep_nonSmoke_remainingSites_civilian_DG.Rdata")
sites<-unique(sites)
...
save(results, file="PGC_EWAS_nonSmoke_inverseNorm_remainingSites_civilian_DG_10.05.17.Rdata")
