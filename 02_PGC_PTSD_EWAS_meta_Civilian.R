...
save(res, file="PGC_EWAS_nonSmoke_inverseNorm_intersectSites_civilian_10.05.17.Rdata")
...
save(results, file="PGC_EWAS_nonSmoke_inverseNorm_remainingSites_civilian_10.05.17.Rdata")
