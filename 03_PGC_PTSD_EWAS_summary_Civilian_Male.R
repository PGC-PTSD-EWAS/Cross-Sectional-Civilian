########################################################################################
# PGC EWAS Civilian Male Meta-Analysis: Summarizing Results
########################################################################################
...
setwd("/Users/ly2207/Documents/Andrew/R/PGC/Current/PGC_EWAS/Civilian/Male/")
...
pdf("PGC_EWAS_Civilian_males_forestPlots.pdf")
for(ii in 1:nrow(results)){
