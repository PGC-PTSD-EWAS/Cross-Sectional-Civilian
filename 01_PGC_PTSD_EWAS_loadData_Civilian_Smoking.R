...
setwd("/Users/aratanat/Dropbox/PTSD methylation workgroup Results Files/Smoking/")
homeDir<-"/Users/aratanat/Documents/R/PGC_EWAS/Current/PGC_EWAS/Civilian/Smoke/DNHS_GTP/"
...
setwd(homeDir)
save.image("PGC_EWAS_combinedData_civilian_DG_smoking.Rdata")
rm(list=ls())
...
load("PGC_EWAS_combinedData_civilian_DG_smoking.Rdata")
...
write.csv(tab, "PGC_EWAS_individualCohort_results_civilian_DG_smoking.csv")
