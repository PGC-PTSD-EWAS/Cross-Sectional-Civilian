...
setwd("/Users/aratanat/Dropbox/PTSD methylation workgroup Results Files/Non_Smoking/")
homeDir<-"/Users/aratanat/Documents/R/PGC_EWAS/Current/PGC_EWAS/Civilian/nonSmoke/DNHS_GTP/"
...
setwd(homeDir)
save.image("PGC_EWAS_combinedData_civilian_DG.Rdata")
rm(list=ls())
...
write.csv(tab, "PGC_EWAS_individualCohort_results_civilian_DG.csv")
